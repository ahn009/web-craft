        ...
        >
          <div className="text-center mb-8">
            <div className="w-14 h-14 rounded-xl bg-cyan/10 flex items-center justify-center mx-auto mb-4">
              <LogIn className="w-7 h-7 text-cyan" />
            </div>
            <h1 className="text-3xl font-bold mb-2">Welcome back</h1>
            <p className="text-muted-foreground">Sign in to your <span className="gradient-text">WebCraft AI</span> account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/forgot-password" className="text-sm text-cyan hover:text-cyan-400 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            ...
            <Link to="/register" className="text-cyan hover:text-cyan-400 font-medium transition-colors">
              Create one
            </Link>
          </p>
        </motion.div>
